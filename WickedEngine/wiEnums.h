...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_POSTPROCESS_SSGI_DEINTERLEAVE_RGBA16F,
		CSTYPE_POSTPROCESS_SSGI_RGBA16F,
		CSTYPE_POSTPROCESS_SSGI_WIDE_RGBA16F,
		CSTYPE_POSTPROCESS_SSGI_UPSAMPLE_RGBA16F,
		CSTYPE_POSTPROCESS_SSGI_UPSAMPLE_WIDE_RGBA16F,
