...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_RESTIR_PRESAMPLE_LIGHTS,
		CSTYPE_RESTIR_DI_INITIAL,
		CSTYPE_RESTIR_DI_TEMPORAL,
		CSTYPE_RESTIR_DI_SPATIAL,
		CSTYPE_RESTIR_DI_SPATIAL_HASHGRID,
		CSTYPE_RESTIR_DI_HASHGRID_BUILD,
		CSTYPE_RESTIR_DI_HASHGRID_OFFSETS,
		CSTYPE_RESTIR_DI_HASHGRID_SORT,
		CSTYPE_RESTIR_DI_DENOISE_TEMPORAL,
		CSTYPE_RESTIR_DI_DENOISE_SPATIAL,
		CSTYPE_RESTIR_GI_TRACE,
		CSTYPE_RESTIR_GI_TEMPORAL,
		CSTYPE_RESTIR_GI_SPATIAL,
		CSTYPE_RESTIR_GI_DENOISE_TEMPORAL,
